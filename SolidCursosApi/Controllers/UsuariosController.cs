...
namespace SolidCursosApi.Controllers
{
   // [Authorize]
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public Usuario Autenticacao([FromForm] Usuario usuario)
        {
            var usu = _context.Usuarios.Where(x => x.Login == usuario.Login && x.Senha == usuario.Senha).FirstOrDefault();
