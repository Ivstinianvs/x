...
namespace SolidCursosApi.Controllers
{
    ...
    public class AutenticacaoController : Controller
    {
        ...
        //https://localhost:44384/api/autenticacao/login?Login=Gabriel&Senha=123

        [HttpGet]
        [Route("login-teste")]
        public ActionResult<dynamic> AuthenticateTeste([FromQuery] UsuarioAutenticacao model)
        {
            // Recupera o usuário
        ...
        [Route("login")]
        public ActionResult<dynamic> Authenticate([FromQuery]UsuarioAutenticacao model)
        {
            // Recupera o usuário
            var user = _context.Usuarios.SingleOrDefault(o => o.Login == model.Login && o.Senha == model.Senha);
